...
watchHistorySchema.index({ user: 1, video: 1, watchedAt: -1 });
watchHistorySchema.index({ video: 1, watchedAt: -1 });

// Static method to add or update watch history
watchHistorySchema.statics.addWatchHistory = async function(userId, videoId, progress, completed, deviceType = 'mobile', sessionDuration = 0) {
